...
extension CacheLevel {
  ...
  */
  ...
  public func transformKeys<A>(_ transformerClosure: (A) -> Future<KeyType>) -> BasicCache<A, OutputType> {
...
public func transformKeys<A, B: OneWayTransformer>(_ transformer: B, fetchClosure: (_ key: B.TypeOut) -> Future<A>) -> BasicCache<B.TypeIn, A> {
...
*/
@available(*, deprecated: 0.5)
public func transformKeys<A, B, C>(_ transformerClosure: (C) -> Future<A>, fetchClosure: (_ key: A) -> Future<B>) -> BasicCache<C, B> {
...
*/
@available(*, deprecated: 0.5)
public func transformKeys<A: CacheLevel, B: OneWayTransformer>(_ transformer: B, cache: A) -> BasicCache<B.TypeIn, A.OutputType> where A.KeyType == B.TypeOut {
...
*/
@available(*, deprecated: 0.5)
public func transformKeys<A: CacheLevel, B>(_ transformerClosure: (B) -> Future<A.KeyType>, cache: A) -> BasicCache<B, A.OutputType> {
 ...
 */
@available(*, deprecated: 0.7)
public func =>><A, B: OneWayTransformer>(transformer: B, fetchClosure: (_ key: B.TypeOut) -> Future<A>) -> BasicCache<B.TypeIn, A> {
  return wrapClosureIntoFetcher(fetchClosure).transformKeys(transformer)
}
 ...
 */
@available(*, deprecated: 0.7)
public func =>><A, B, C>(transformerClosure: (C) -> Future<A>, fetchClosure: (_ key: A) -> Future<B>) -> BasicCache<C, B> {
  return wrapClosureIntoFetcher(fetchClosure).transformKeys(transformerClosure)
}
